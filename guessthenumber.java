...
public class guessthenumber {
    public static void main(String[] args) {
        System.out.println("Let's play a guess game. I'll pick a number between");
    ...
    static void playGame() {
        ...
        while (true) {
            ...
            if (usersGuess == computersNumber) {
                System.out.println("You got it in " + guessCount + " guesses! The number was " + computersNumber);
                break;  
            }
            if (guessCount == 6) {
